...
pub fn solve(part: Part, input: impl BufRead) -> color_eyre::Result<Solution> {
    ...
    Ok(match part {
        Part::One => Solution::Num(system.eval_z()),
        Part::Two => {
            // Solved part 2 by hand with the help of diagrams generated by
            // ../../ruby/day24-part2.rb
            Solution::Str("fcd,fhp,hmk,rvf,tpc,z16,z20,z33".into())
        }
    })
}
